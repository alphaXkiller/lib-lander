  ...
  render() {
    return (
      <div>
        <div className="mc">
    			...
    			<div className="pc">
    				...
    				<div className="logo" id="logo">
    					<div className="logobox" id="logobox" data-tilt data-tilt-reset="false" data-tilt-perspective="2000">
    						<Logo />
    					</div>
    				</div>
    				...
    				{/* <!-- SOCIAL SIDEBAR --> */}
    				<div className="sidebar sbmobile">
    					{/* <!-- SNAPS! --> */}
    				...
    				{/* <!-- FOOTER --> */}
    				<div className="libfooter mobile libfoot-off">
    					<ul>
    						<li><a href="mailto:LIBPress@rrpartners.com?subject=Life%20Is%20Beautiful%20Press%20Inquiries">Press</a></li>
    						<li>|</li>
    					...
    					<span className="copyright">&copy; 2017 Life Is Beautiful.<br />All Rights Reserved.</span>
    				</div>
    				{/* <!-- FOOTER --> */}
    				{/* <!-- CONTENT --> */}
        ...
        {/* <!-- FOOTER --> */}
        <div className="libfooter desktop libfoot-off">
    			<ul>
